...
class MBPOAgent(BaseAgent):
    ...
    def collect_model_trajectory(self, rollout_length=1):
        ...
        ob, _, _, _, terminal = self.mb_agent.replay_buffer.sample_random_data(batch_size=1) # TODO
        ...
        for _ in range(rollout_length):
            ...
            next_ob = np.mean([model.get_prediction(ob, ac, self.mb_agent.data_statistics) for model in self.mb_agent.dyn_models], axis=0) # TODO
